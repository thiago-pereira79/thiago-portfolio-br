        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 h-16 md:h-20 flex items-center justify-between">
         ...
         />
          ...
          <nav className="hidden md:flex space-x-8">
            ...
            <NavLink href="#estudos">ESTUDOS</NavLink>
            <NavLink href="#sobre">SOBRE</NavLink>
            <NavLink href="#idiomas">IDIOMAS</NavLink>
        ...
        {isMenuOpen && (
          <div className="md:hidden absolute top-16 left-0 right-0 bg-background border-b border-secondary/10 py-8 px-6 shadow-lg h-screen md:h-auto overflow-y-auto">
            <nav className="flex flex-col space-y-6 text-center text-lg">
              <NavLink href="#inicio" onClick={toggleMenu}>INÍCIO</NavLink>
              <NavLink href="#skills" onClick={toggleMenu}>SKILLS</NavLink>
              <NavLink href="#projetos" onClick={toggleMenu}>PROJETOS</NavLink>
              <NavLink href="#estudos" onClick={toggleMenu}>ESTUDOS</NavLink>
              <NavLink href="#sobre" onClick={toggleMenu}>SOBRE</NavLink>
              <NavLink href="#idiomas" onClick={toggleMenu}>IDIOMAS</NavLink>
              <NavLink href="#contato" onClick={toggleMenu}>CONTATO</NavLink>
            </nav>
          </div>
        )}
      </header>
      ...
      <main className="pt-16 md:pt-20">
        ...
        <Section id="skills" bgClass="bg-[#D6C9BC]" className="!pb-10">
          ...
          <p className="text-center text-secondary/60 mt-8 text-sm">
            Sempre estudando e atualizando o stack conforme os projetos pedem.
          </p>
        </Section>
        ...
        <Section id="projetos" bgClass="bg-[#CDBFAF]" className="!pt-10">
          <div className="mb-10 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-4 md:mb-6">Projetos em destaque</h2>
            <p className="text-secondary text-base md:text-lg">
              Alguns experimentos em Front-end, Mobile e lógica que estou construindo ao longo dos cursos e bootcamps.
            </p>
          </div>
        ...
        <Section id="estudos" bgClass="bg-[#D6C9BC]">
          <div className="text-center mb-10 md:mb-16">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-4">Em estudo agora</h2>
            <p className="text-secondary text-base md:text-lg max-w-3xl mx-auto">
              Hoje meu foco está em aprofundar a base de Front-end, avançar em desenvolvimento Mobile e consolidar os fundamentos de Cloud (AWS).
            </p>
          </div>
        ...
        <Section id="sobre" bgClass="bg-[#CDBFAF]">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-8 md:mb-12">Sobre mim</h2>
        ...
        <Section id="idiomas" bgClass="bg-[#D6C9BC]" className="!pb-10">
           <div className="">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-8 md:mb-12">Idiomas</h2>
            <div className="flex flex-col sm:flex-row gap-8 sm:gap-16">
                <div>
                  <h4 className="font-bold text-accent text-lg">Português</h4>
                  <p className="text-secondary text-lg">Nativo</p>
                </div>
                <div>
                  <h4 className="font-bold text-accent text-lg">Inglês</h4>
                  <p className="text-secondary text-lg">Em curso</p>
                </div>
                <div>
                  <h4 className="font-bold text-accent text-lg">Espanhol</h4>
                  <p className="text-secondary text-lg">Em curso</p>
                </div>
            </div>
          </div>
        ...
        <Section id="contato" bgClass="bg-[#CDBFAF]" className="!pt-10">
          <div className="text-center max-w-4xl mx-auto">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-primary mb-6 md:mb-8">Contato</h2>
            <p className="text-secondary text-base md:text-lg mb-8 md:mb-12 leading-relaxed">
              Aberto para networking, oportunidades como estagiário/júnior em Front-end, Mobile ou Cloud, e conversas sobre estudos e projetos.
            </p>
      ...
      <footer className="bg-[#281F1A] text-[#EAE0D5] py-8 md:py-12 border-t border-secondary/20">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <p className="opacity-80 text-xs md:text-sm">
            © {new Date().getFullYear()} • Portfólio de Thiago Pereira • Front-end • Mobile • Cloud
          </p>
        </div>
      </footer>
    </div>
