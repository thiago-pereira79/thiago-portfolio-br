    ...
    <section id="skills" className="py-20 px-4 sm:px-6 lg:px-8 bg-cream-100">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-terracotta text-lg">Um pé no Front-end, outro no Mobile e um olho na nuvem.</p>
        </div>
        ...
        <div className="text-center mt-12 text-brown-800/60 text-sm">
          <p>Sempre estudando e atualizando o stack conforme os projetos pedem.</p>
        </div>
      </div>
    </section>
  );
