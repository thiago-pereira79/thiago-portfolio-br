          ...
          <div className="flex flex-col space-y-8 order-2 lg:order-1 text-left">
            <div>
              ...
              <h2 className="text-xl sm:text-2xl text-terracotta font-medium leading-relaxed text-justify">
                Estudante de ADS focado em Front-end, Mobile e Cloud (AWS).
              </h2>
            </div>

            <p className="text-base sm:text-lg text-brown-700 leading-relaxed max-w-xl text-justify">
              Desenvolvo interfaces web e mobile enquanto aprofundo meus estudos em React, Flutter e computação em nuvem pela Escola da Nuvem | AWS. Trago comigo uma base em Relações Internacionais e experiência com pessoas, atendimento e tecnologia.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              >
                Ver Projetos <ArrowRight size={18} className="ml-2" />
              </a>
            </div>
          </div>
